...
import 'package:labtech/src/views/tabs/tab_view.dart';
import 'package:labtech/src/views/splash_screen.dart';
...
class HosepctionState extends State<Hosepction> {
  ...
  void initState() {
    super.initState();
    StorageService st = new StorageService();
    st.checkSurveyPendingSubmission();
  }
